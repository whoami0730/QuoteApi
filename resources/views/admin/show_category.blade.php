...
<head>
    ...
    <title>All Quotes Category</title>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('/storage/CategoryImage/' .$item->image) }}" alt="Category Image"
                                                        width="150px"></td>
                                                <td><button class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#editModal{{$item->id }}">Edit</button></td>
                                                <td><a href="{{ 'delete_category/' . $item->id }}"><button class="btn btn-danger btn-sm" onclick=" return confirm('You Want To Delete Data')">Delete</button></a></td>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form method="POST"
                                                                        ...
                                                                        @csrf
                                                                        <div class="my-2 text-primary fs-3 text-center text-uppercase fw-bold">Edit Category</div>
                                                                        ...
                                                                        <div class="my-1">
                                                                            <img src="{{ asset('/storage/CategoryImage/' .$item->image) }}" alt="" class="img-thumbnail" width="120px">
                                                                        </div>
                                                                        <div class="input-group mt-2">
